...
<?php include('includes/sidebar.php');?>
 ...
 <?php $query=mysqli_query($bd, "select tablecomplaints.*,category_id.categoryName as catname from tablecomplaints join category on category_id.id=tablecomplaints.category where sr-code='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
