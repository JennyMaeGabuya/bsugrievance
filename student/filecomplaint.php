...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Complaint For Student</option>
                  ...
                  <option value="General Query">Complaint For Services</option>
                  <option value="General Query">Complaint For Facilities</option>
                  <option value="General Query">Complaint For Teachers</option>
                </select> 
</div>
 </div>
