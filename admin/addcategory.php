...
?>									
										<tr>
											...
											<td>
											<a href="edit-category.php?category_id=<?php echo $row['category_id']?>" ><i class="icon-edit"></i></a>
											<a href="category.php?category_id=<?php echo $row['category_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
